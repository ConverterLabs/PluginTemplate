...
class PluginTemplate_Class : public QObject, public Platform_Interface
{
    Q_OBJECT
...
public:
    ...
    PluginTemplate_Class(QObject* messenger_);
    ~PluginTemplate_Class();
...
class PluginTemplate_Class_Fabric : public QObject, Platform_Fabric
{
    Q_OBJECT
...
public:
    Platform_Interface* GetInterface(QObject* messenger) Q_DECL_OVERRIDE {
        return dynamic_cast<Platform_Interface*>(new PluginTemplate_Class(messenger))
                ;}
};
